...
class ExecControlProvisioner(object):
    ...
    def __init__(self, args_str=None):
        ...
        api_server_port = self._args.api_server_port if self._args.api_server_port else "8082"
        contrail_config_ip = self._args.api_server_ip if self._args.api_server_ip else '127.0.0.1'
